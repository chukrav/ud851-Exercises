...
public class MainActivity extends AppCompatActivity {
    ...
    private String LIFECYCLE_CALLBACKS_TEXT_KEY = "lifeCycleCallback";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            if (savedInstanceState.containsKey(ON_SAVE_INSTANCE_STATE)){
                String in_text = savedInstanceState.getString(ON_SAVE_INSTANCE_STATE);
                mLifecycleDisplay.setText(in_text);
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String outText = mLifecycleDisplay.getText().toString();
        outState.putString(ON_SAVE_INSTANCE_STATE, outText);
