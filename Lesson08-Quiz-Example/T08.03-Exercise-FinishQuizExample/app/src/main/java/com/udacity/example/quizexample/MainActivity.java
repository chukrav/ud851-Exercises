...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mWordTextDefinition, mWordTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWordTextDefinition = (TextView) findViewById(R.id.text_view_definition);
...
//        String definition = cursor.getString(definitionCol);
        ...
        if (mData != null) {
            ...
            mWordTextDefinition.setText(mData.getString(mDefColumn));
            mWordTextDefinition.setVisibility(View.INVISIBLE);
    ...
    public void showDefinition() {
        ...
        mWordTextDefinition.setVisibility(View.VISIBLE);
