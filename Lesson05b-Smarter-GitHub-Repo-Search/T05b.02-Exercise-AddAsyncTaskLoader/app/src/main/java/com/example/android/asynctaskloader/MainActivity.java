...
//        new GithubQueryTask().execute(githubSearchUrl);
    ...
    @Override
    public android.support.v4.content.Loader<String> onCreateLoader(int i, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                if (searchQueryURLExtra == null || searchQueryURLExtra.isEmpty())
                    return null;
                try {
                    URL urlToSend = new URL(searchQueryURLExtra);
                    githubSearchResults = NetworkUtils.getResponseFromHttpUrl(urlToSend);
